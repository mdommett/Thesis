...
%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%
\subsection{Exciton Hopping the Marcus Regime}\label{section: Connecting_Marcus}
%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%
...
The oscillator strength between \sone{} and \szero{} states at the \Kstar{} minimum is 0.549, indicating that emission will be bright. The radiative decay rate can be calculated using the Einstein spontaneous emission:
\begin{equation}
...
%For \textbf{HP1}, the large reorganisation energy and low oscillator strength reduce the hopping and radiative rates in the enol regime, with emission from the \Kstar{} minimum highly favourable (with CASPT2, $k_{r,K*}$ is \SI{1.79e8}{s^{-1}}). 
...
\begin{comment}
\begin{table}
\caption{Hopping rates $\nu_{}$ and radiative rates $k_{r,}$ in the enol (\Estar{}) and keto (\Kstar{}) regimes for \textbf{HC1}, \textbf{HC5}, \textbf{HP1}. All rates in \SI{}{s^{-1}}, calculated at TD-$\omega$B97X-D/6-31G(d):AMBER level.} 
  \label{table: rates}
  \begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}lllll}
  \hline
  System & $\nu_{E*}$ &  $\nu_{K*}$ & $k_{r,E*}$ & $k_{r,K*}$\\
  \hline
  \textbf{HC1} & \SI{4.19e13}{} & \SI{1.05e11}{} & \SI{5.61e8}{} & \SI{2.83e8}{} \\
  \textbf{HC5} & \SI{3.92e11}{} & \SI{2.73e10}{} & \SI{6.62e5}{} & \SI{1.02e8}{} \\
  \textbf{HP1} & \SI{3.20E4}{} & \SI{2.03E8}{} &   \SI{1.92E6}{} & \SI{1.23e8}{} \\
  \hline
  \end{tabular*}
\end{table}
\end{comment}
